...
def handle_api(path):
    ...
    try:
        # ===== SERVO COMMANDS =====
        if path == "/s15_cw":   set_servo(15, SLOW_CW)
        elif path == "/s15_ccw": set_servo(15, SLOW_CCW)

        elif path == "/s16_cw":   set_servo(16, SLOW_CW)
        elif path == "/s16_ccw":  set_servo(16, SLOW_CCW)

        elif path == "/s17_cw":   set_servo(17, FAST_CW)
        elif path == "/s17_ccw":  set_servo(17, FAST_CCW)

        elif path == "/s18_cw":   set_servo(18, SLOW_CW)
        elif path == "/s18_ccw":  set_servo(18, SLOW_CCW)
